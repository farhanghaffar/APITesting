...
public class PropertiesReader {
     ...
     public static Properties readApiProp() {
         ...
         try {
                         ...
                         fis = new FileInputStream(System.getProperty("user.dir")
                                                         ...
                                                         + ""+File.separator+"src"+File.separator+"test"+File.separator+"resources"+File.separator+"config"+File.separator+"ApiConfig.properties");
     ...
     public static String getApiPropertyValue(String prop) {

         String propertyValue = null;

         try {

                         propertyValue = readApiProp().getProperty(prop);
