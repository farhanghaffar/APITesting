package com.bond.errorCollectors;
...
//    public static TestSteps verifyTrue(boolean condition, String message) {
//    	try {
////    		assertTrue(condition, message);
//    		Assert.assertTrue(condition, message);
//    		return new TestSteps(message,Status.PASS);
//    	}catch(Throwable e) {
//    		ExtentListeners.captureErrorAndScreenshot(e);
//    		addVerificationFailure(e);
//    		return new TestSteps(message,Status.FAIL);
//    	}
//    }
    
    public static Status verifyTrue(boolean condition, String message) {
    	try {
    		Assert.assertTrue(condition, message);
			return Status.PASS;
		} catch (Exception e) {
    ...
    public static TestSteps verifyStepTrue(boolean condition, String message) {
    	try {
    		assertTrue(condition, message);
...
//    public static TestSteps verifyFalse(boolean condition, String message) {
//    	try {
...
//    }
    ...
    public static Status verifyFalse(boolean condition, String message) {
    	try {
    		assertFalse(condition, message);
			return Status.PASS;
		} catch (Exception e) {
    ...
    public static TestSteps extentLogInfo(String message) {
    	try {
    		 
    		 return new TestSteps(message,Status.INFO);
		} catch(Throwable e) {
    		addVerificationFailure(e);
    		return new TestSteps(message,Status.FAIL);
		}
