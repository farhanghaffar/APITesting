...
public class TestSubAggregatorApi extends BaseClass {
	...
	public void VerifyAggregatorApiInHLApi() {
		...
		try {
			...
			map.put("<b>***************Create and Verify Sub-Aggregator Request***************</b>",osqoApiPage.subAggregator());
			...
			driver.close();
			try {
				addTestStepsIntoReport(testStatus, map, "Sub-Aggregator Request And Verify On HL","");
