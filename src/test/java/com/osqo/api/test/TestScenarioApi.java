...
public class TestScenarioApi extends BaseClass {
	...
	public void VerifyAggregatorApiInHLApi() {
		...
		try {
			...
			map.put("<b>***************Scenario Request***************</b>",osqoApiPage.scenario(false));
			...
			driver.close();
			try {
				addTestStepsIntoReport(testStatus, map, "Scenario Request And Verify On HL","");
