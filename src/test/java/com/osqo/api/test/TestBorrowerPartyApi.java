...
public class TestBorrowerPartyApi extends BaseClass {
	...
	public void VerifyAggregatorApiInHLApi() {
		...
		try {
			...
			map.put("<b>***************Borrower Party Request***************</b>",osqoApiPage.borrowerParty(false));
			...
			driver.close();
			try {
				addTestStepsIntoReport(testStatus, map, "Borrower Request And Verify On HL","");
