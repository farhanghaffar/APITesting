...
public class TestBrokerGroupApi extends BaseClass {
	...
	public void VerifyAggregatorApiInHLApi() {
		...
		try {
			...
			map.put("<b>***************Broker-Group-Request***************</b>",osqoApiPage.BrokerGroup(false));
			...
			driver.close();
			try {
				addTestStepsIntoReport(testStatus, map, "Broker Group Request And Verify On HL","");
