...
public class TestGuarantorApi extends BaseClass {
	...
	public void VerifyAggregatorApiInHLApi() {
		...
		try {
			...
			map.put("<b>***************Guarantor Request***************</b>",osqoApiPage.guarantor(false));
			...
			driver.close();
			try {
				addTestStepsIntoReport(testStatus, map, "Guarantor Request And Verify On HL","");
