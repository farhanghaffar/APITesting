...
public class TestInvestorApi extends BaseClass {
	...
	public void VerifyAggregatorApiInHLApi() {
		...
		try {
			...
			map.put("<b>***************Investor Request***************</b>",osqoApiPage.createInvestor());
			...
			driver.close();
			try {
				addTestStepsIntoReport(testStatus, map, "Investor Request And Verify On HL","");
