...
public class TestAggregatorApi extends BaseClass {
	...
	public void VerifyAggregatorApiInHLApi() {
		...
		try {
			...
			map.put("<b>*************** Create and Verify Aggregator Request ***************</b>",osqoApiPage.aggregator());
			...
			driver.close();
			try {
				addTestStepsIntoReport(testStatus, map, "Aggregator Request And Verify On HL","");
